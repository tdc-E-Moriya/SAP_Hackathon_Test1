...
- risk：
  ...
  例）平均は10000で過去平均比が15%ほど増加している。リスクが高いため確認が必要です。
- reason：
  リスクの種類を1フレーズで分類（ラベル）
...
- 件名：「見積回答についてご確認」
- 本文：
  「（仕入先名）ご担当者様 平素よりお世話になっております。
   TDCソフトの○○です。
   見積内容について、以下の点を確認させてください。」で開始してください。開始の文には句点の後に開業を追加してください。
- リスク項目を簡潔に箇条書きで改行コードを使って改行してください。文字化けしないようにしてください。
